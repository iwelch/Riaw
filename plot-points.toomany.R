...
## this is sort of like the "points" function, but plots gray scales rather than points.
## useful when one has hundreds of thousands of points

iaw$points.toomany <- function( x, y, bandwidth, inlogs=TRUE, colstrength=1, ... ) {
