...
#' @name mclapply
#'
#' just like lapply, but multicore and backed by cache
#'
#' @usage mc.by (X, FUN, ..., mc.preschedule=TRUE)
#'
#' @param see lapply
#'
#' @return a list
...
### these will be picked up by rbind.mc.by .  good to use ourselves, too
